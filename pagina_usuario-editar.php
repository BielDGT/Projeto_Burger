        ...
        <section class="row-pagina-usuario" class="text-center">
            ...
            <div class="formulario">
                <form>
                    ...
                    <input type="text" class="formulario-campo" placeholder="Email" value="<?php echo $resultado['senha'] ?>">><br>
                    <input type="text" class="formulario-campo" placeholder="Senha" value="<?php echo $resultado['email'] ?>">><br>
